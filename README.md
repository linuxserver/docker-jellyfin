...
<!-- Please read the https://github.com/linuxserver/docker-jellyfin/blob/nightly/.github/CONTRIBUTING.md -->
...
* Update the image: `docker pull lscr.io/linuxserver/jellyfin:nightly`
