...
Instead edit the [readme-vars.yml](https://github.com/linuxserver/docker-jellyfin/edit/bionic/readme-vars.yml).
...
If you are modifying the Dockerfiles or any of the startup scripts in [root](https://github.com/linuxserver/docker-jellyfin/tree/bionic/root), add an entry to the changelog
